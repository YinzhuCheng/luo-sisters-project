...
Source HTML: `character_sheets/qingyou.html`

## Content
古风手账式设定页
# 洛青悠
古风 Lolita｜规划者｜记录者｜温柔姐姐 | 用秩序保护梦想的人。她把梦写进手账，给冒险准备茶、伞与回程路。
[返回总览](../index.md) [查看整版参考图](../../assets/characters/qingyou/source_sheet/luo_qingyou_character_sheet_v2.png) [资产](../knowledge/assets.md)
...
## 整版参考图
[image placeholder: alt="整版参考图" src="../../assets/characters/qingyou/source_sheet/luo_qingyou_character_sheet_v2.png"]
...
拍照姿势待生成
待生成assets/characters/qingyou/generated/transparent/poses/flip-journal-v1.png
翻手账姿势待生成
待生成assets/characters/qingyou/generated/transparent/poses/offer-tea-v1.png
递茶姿势待生成
待生成assets/characters/qingyou/generated/transparent/poses/prepare-umbrella-v1.png
准备雨伞姿势待生成
...
## 人物标签
温柔可靠细致周全审美敏锐独立干练热爱记录责任感强计划达人暖心姐姐
资产扩展
## 资产槽位
当前页面先用参考截图和占位槽稳定版式；透明 PNG 生成后会自动替换进入对应槽位。
## 服饰拆解
...
整理领结姿势待生成
## 代表 CG
待生成assets/characters/qingyou/generated/transparent/cg/old-street-light-v1.png
旧街光影待生成
待生成assets/characters/qingyou/generated/transparent/cg/rain-plan-blank-v1.png
雨天计划空白待生成
工作流
## 工作流
...
## 日常细节
- 提前到达约定地点，包里常备发夹、胶带、便签和创可贴。
- 拍照前先看光，再看人。
- 喜欢给灵感留一页，也喜欢给计划留一栏“意外”。
- 听见有栖的新点子，会先翻开手账，再微笑回应。
## 成长方向
从亲手完成所有步骤来证明价值，成长为能使用 LLM 与 AIGC 搬开重复劳动，把判断、选择、关系和心意留给自己。最终形成“有弹性的秩序”。
...
- `asset | ok` 查看整版参考图: [../../assets/characters/qingyou/source_sheet/luo_qingyou_character_sheet_v2.png](../../assets/characters/qingyou/source_sheet/luo_qingyou_character_sheet_v2.png)
